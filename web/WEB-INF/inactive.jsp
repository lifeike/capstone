...
<html>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark primary-color">
                ...
                <div class="collapse navbar-collapse" id="basicNav">
                    ...
                    <ul class="navbar-nav mr-auto p-1  bg-dark">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="/inactive">Inactive Customers
        ...
        <div id="body-main">
            <h3 id="heading">Inactive Customers</h3>
            <br>
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <c:forEach items="${iausers}" var="us">
                    <td>${us.email}</td>
                    <td>${us.firstName}</td>
                    <td>${us.lastName}</td>
                    <td>${us.role.roleDescription}</td>
                    <td>
